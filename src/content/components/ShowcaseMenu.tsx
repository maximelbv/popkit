  ...
  steps: [
    {
      ...
      description:
        "Copy and paste the following code into your components folder",
      codeBlock: {
        // js: ,
        // ts: ,
        // jsTailwind: ,
...
const overview = {
  miniPreview: () => (
    <MiniPreviewWrapper>
      <ShowcaseMenuDemo items={previewMockedItems} />
    </MiniPreviewWrapper>
  ),
  preview: () => (
...
export default function ShowcaseMenuPreview() {
  return <ShowcaseMenu items={previewItems} />
}`,
